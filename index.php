<?php
include ('pages/components/metahead.php')
  <!-- Header -->
    <nav id="navbar">
        <div class="container">
    ...
    <section id="home" class="hero">
        <div class="slider">
            <div class="slides">
                ...
                <!-- Slide 1 -->
                <div class="slide">
                    <div class="slide-bg" style="background-image: url('https://images.unsplash.com/photo-1507238691740-187a5b1d37b8?ixlib=rb-4.0.3&auto=format&fit=crop&w=1955&q=80');"></div>
                    <div class="container">
                        <div class="slide-content">
                            <div class="hero-text">
                                ...
                                <p>A UI/UX designer focuses on creating visually appealing and user-friendly websites that deliver seamless experiences.</p>
                            ...
                            <div class="hero-image">
                                <img src="images/slider1.avif" alt="Designer Profile">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="container">
                        <div class="slide-content">
                            <div class="hero-text">
                                ...
                                <p>I create functional websites and applications with a focus on user experience and modern design principles</p>
                                <a href="#portfolio" class="btn">View My Work</a>
                                <div class="social-icons">
                                    <a href="https://www.facebook.com/stylishprabesh1"><i class="fab fa-facebook-f"></i></a>
                                    <a href="https://www.instagram.com/stylishprabesh"><i class="fab fa-instagram"></i></a>
                                    <a href="https://www.linkdin.com/prabesh"><i class="fab fa-linkedin-in"></i></a>
                                    <a href="https://github.com/stylishprabesh"><i class="fab fa-github"></i></a>
                                                                        <a href="https://x.com/stylishprabesh"><i class="fa-brands fa-x-twitter"></i>

                                </div>
                            </div>
                            <div class="hero-image">
                                <img src="images/slider2.avif" alt="Designer Profile">
                            </div>
                        </div>
                    </div>
                </div>
         ...
         <!-- Slide 3 -->
                ...
                <!-- Slide 4 -->
                <div class="slide">
                    <div class="slide-bg" style="background-image: url('https://images.unsplash.com/photo-1558655146-d09347e92766?ixlib=rb-4.0.3&auto=format&fit=crop&w=1950&q=80');"></div>
                    <div class="container">
                        <div class="slide-content">
                            <div class="hero-text">
                                ...
                                <p>With over 7 years of experience, I help businesses transform their digital presence through innovative design and development.</p>
                            ...
                            <div class="hero-image">
                                <img src="images/slider3.avif" alt="Digital Solutions">
                            </div>
                        </div>
                    </div>
                </div>
